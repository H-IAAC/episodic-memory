...
public class T2DStringIdea {
    ...
    private T2DStringIdea() {
    }

    public static OccupancyGridIdea createOccupancyGrid(ArrayList<Idea> objectList, int imageWidth, int imageHeight, int columnsX, int rowsY){
...
//            
        ...
        OccupancyGridIdea occupancyGrid = new OccupancyGridIdea(itemCount, f2, aux);
    ...
    public static String create2DStringPattern(OccupancyGridIdea occupancyGrid, int imageWidth, int imageHeight, int columnsX, int rowsY) {
    ...
    public static OccupancyGridIdea decodeMatrixAndReplace(HashMap<Integer,Integer> newIds,String strImage, int columnsX, int rowsY) {
        ...
        OccupancyGridIdea occupancyGrid = new OccupancyGridIdea(itemCount, img, permutacion);//itemsAx.size(), img, permutacion);
...
//                    if(skip)continue;
        ...
        ArrayList<Set<Integer>> maximalCliques = BronKerboschPivotCliqueIdea.findMaxCliques(neighbors);
