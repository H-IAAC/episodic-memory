 ...
 */
package episodicv2.core.configuration;
/*
...
public class Configuration {
    ...
    public static final long CONSOLIDATION_INTERVAL = 5000; // * 60 * 24; //1000 * 60 * 60 * 24;
    ...
    public static final String OBJECT_ID_IDEA = "objectIdIdea";
    public static final String OBJECT_ID_1_IDEA = "object1IdIdea";
    public static final String OBJECT_ID_2_IDEA = "object2IdIdea";
    ...
    public static final String STORED_SCENE_RELATION_IDEA = "storedSceneRelationIdea";
    ...
    public static final String REQUEST_OBJECT_RELATION_MO = "requestObjectRelationMO";
