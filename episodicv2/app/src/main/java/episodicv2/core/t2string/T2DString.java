 ...
 *
 *
 * bench : 52.24987268447876 (490, 197, 513, 213) bench : 88.85419368743896 (77,
 * 236, 227, 309) bench : 89.26724195480347 (489, 225, 541, 273) person :
 * 51.96205377578735 (156, 200, 181, 233) person : 61.796534061431885 (111, 197,
 * 124, 231) person : 69.16193962097168 (318, 189, 355, 308) person :
 * 90.48594236373901 (432, 176, 450, 215) person : 98.03987145423889 (189, 174,
 * 210, 227) person : 98.34442138671875 (288, 195, 341, 314) person :
 * 99.28038716316223 (123, 180, 151, 241)
 *
 *
 */
public class T2DString {
    ...
    public static OccupancyGrid createOccupancyGrid(ArrayList<CObject> objectList, int imageWidth, int imageHeight, int columnsX, int rowsY){
        ...
        for (int i = 0; i < objectList.size(); i++) {
            ...
            CObject object = objectList.get(i);
            int id = object.getPreId();
            int cx = object.getX();
            int cy = object.getY();
            int px = cx / dx;
            int py = cy / dy;
