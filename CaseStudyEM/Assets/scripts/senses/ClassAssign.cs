...
public class ClassAssign : MonoBehaviour
{
    //Based on yoloh5
    ...
    //'cake': 56, 'chair': 57, 'sofa': 58, 'potted plant': 59, 'bed': 60, 
    ...
    //'vase': 76, 'scissors': 77, 'teddy bear': 78, 'hair drier': 79, 'toothbrush': 80, 'couch': 81}
